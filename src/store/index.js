...
import {
  postSignup, postLogin, getGroupNames, getGroup, getGroupResult, getBetByPhase, patchBets, getScoreBoard, postComputePoints,
} from '@/api';
...
const actions = {
  ...
  getBetByPhase(context, { phaseName }) {
    return getBetByPhase(phaseName, context.state.jwt);
  },
